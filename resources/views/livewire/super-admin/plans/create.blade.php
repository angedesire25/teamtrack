{{-- Vue : Création d'un plan --}}

<x-slot:pageTitle>Nouveau plan</x-slot:pageTitle>
...
<div class="max-w-2xl space-y-6">
    ...
    <form wire:submit="save" class="bg-white rounded-xl border border-gray-100 shadow-sm p-6 space-y-5">
        ...
        <h2 class="text-sm font-semibold text-gray-900 border-b border-gray-100 pb-3">Informations du plan</h2>

        <div class="grid grid-cols-2 gap-5">

            <div class="col-span-2">
                <label class="block text-sm font-medium text-gray-700 mb-1.5">Nom <span class="text-red-500">*</span></label>
                <input wire:model="name" type="text" placeholder="Ex : Starter"
            ...
            <div class="col-span-2">
                ...
                <textarea wire:model="features_raw" rows="4" placeholder="Gestion des joueurs&#10;Statistiques avancées&#10;Export PDF"
            ...
            <div class="col-span-2 flex items-center gap-3">
                ...
                <label for="is_active" class="text-sm text-gray-700">Plan actif (visible pour les nouveaux clubs)</label>
            </div>
        ...
        <div class="flex items-center justify-end gap-3 pt-2 border-t border-gray-100">
            ...
            <button type="submit"
                ...
                <span wire:loading.remove>Créer le plan</span>
